...
class App {
  ...
  _loadMap(position) {
    ...
    // Show the marker once the map has been loaded
    this.#workouts.forEach(work => this._renderWorkoutMakrker(work));
  }
  ...
  _newWorkout(e) {
    ...
    this._renderWorkoutMakrker(workout);

    // Render workout on map list
    this._renderWorkout(workout);

    // Hide the submit form and clear the input fields
    this._hideForm();
  ...
  _deleteAllWorkouts() {
    ...
    // Reattach the map click event listener
    this.#map.on('click', this._showForm.bind(this));

    // Update local storage and re-render workouts
    this._setLocalStorage();
